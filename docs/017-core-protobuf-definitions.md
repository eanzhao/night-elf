...
- [protobuf/aelf/transaction.proto](/Users/eanzhao/night-elf/protobuf/aelf/transaction.proto)
- [protobuf/aelf/block.proto](/Users/eanzhao/night-elf/protobuf/aelf/block.proto)
...
`TransactionResult` 这次也一起纳入核心 proto，但只保留 Phase 1 需要的最小字段集，并保留原始字段号，避免为了 `LogEvent` 等非必要依赖把更大范围的 proto 一起拖进来。
